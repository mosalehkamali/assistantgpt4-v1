          ...
          <div className="axplaneContent">
            <div className="axplanText">
              <p className="axplanTextContent">
                دستیار وب جی پی تی: یک همکار هوش مصنوعی پیشرفته دستیار وب جی پی
                تی یک ابزار قدرتمند در دنیای وب است که با قابلیت‌ها و ویژگی‌های
                منحصربه‌فرد خود، تجربه کاربری شما را بهبود می‌بخشد. این دستیار
                هوش مصنوعی، به شما اجازه می‌دهد تا تعاملی فراتر از ساده‌ترین
                مراجعه به وب را تجربه کنید. برخی از قابلیت‌ها و ویژگی‌های برجسته
                دستیار وب جی پی تی به شرح زیر است:
              </p>
              <p className="axplanTextContent">
                شخصی‌سازی: دستیار وب جی پی تی به شما این امکان را می‌دهد تا
                تجربه خود را شخصی‌سازی کنید. با توجه به نیازها و ترجیحات شما،
                می‌توانید ویژگی‌ها و تنظیمات را تغییر دهید تا به شما خدمت بهتری
                ارائه دهد.
              </p>
              <p className="axplanTextContent">
                رابط کاربری محبوب: رابط کاربری دستیار وب جی پی تی بسیار ساده و
                محبوب است. به شما امکان می‌دهد با سهولت به تمامی امکانات و
                ویژگی‌ها دسترسی پیدا کنید و به راحتی با آن تعامل کنید.
              </p>
              <p className="axplanTextContent">
                توانایی درک و استنتاج بالا: این دستیار با بهره‌گیری از هوش
                مصنوعی پیشرفته، توانایی درک نیازهای شما را دارد و می‌تواند
                استنتاجات منطقی بگیرد تا به شما پاسخ‌های دقیق‌تری ارائه دهد.
              </p>
